...
function makeCat(name, age) {
  ...
  //very interesting. There seems to be no variable masking and it really understands
  //that I want to use the argument as the value for the key, which also has the same
  //name
